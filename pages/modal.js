...
function Modal() {
  ...
  const uploadPost = async () => {
    ...
    //3. upload the image to the firebase storage with the post ID as the name
    //4. get the image URL from the storage and add update the original post with image
